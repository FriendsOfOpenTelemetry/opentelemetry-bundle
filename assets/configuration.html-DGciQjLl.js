...
<span class="line">    <span class="token comment"># Service ID used for telemetry export transports. Must implement PSR-18 ClientInterface and PSR-17 RequestFactoryInterface, StreamFactoryInterface. Defaults to Symfony Psr18Client.</span></span>
<span class="line">    <span class="token key atrule">transport_http_client</span><span class="token punctuation">:</span> <span class="token null important">null</span></span>
...
<span class="line">                <span class="token key atrule">tracer</span><span class="token punctuation">:</span>               <span class="token null important">~</span></span>
<span class="line"></span>
<span class="line">                <span class="token comment"># Exclude commands from auto instrumentation</span></span>
<span class="line">                <span class="token key atrule">exclude_commands</span><span class="token punctuation">:</span></span>
<span class="line"></span>
<span class="line">                    <span class="token comment"># Default:</span></span>
<span class="line">                    <span class="token punctuation">-</span> messenger<span class="token punctuation">:</span>consume</span>
<span class="line">            <span class="token key atrule">metering</span><span class="token punctuation">:</span></span>
<span class="line">                <span class="token key atrule">enabled</span><span class="token punctuation">:</span>              <span class="token boolean important">false</span></span>
<span class="line"></span>
<span class="line">                <span class="token comment"># The meter to use, defaults to \`metrics.default_meter\` or first meter in \`metrics.meters\`</span></span>
...
<span class="line">                <span class="token key atrule">tracer</span><span class="token punctuation">:</span>               <span class="token null important">~</span></span>
<span class="line"></span>
<span class="line">                <span class="token comment"># Exclude paths from auto instrumentation</span></span>
<span class="line">                <span class="token key atrule">exclude_paths</span><span class="token punctuation">:</span>        <span class="token punctuation">[</span><span class="token punctuation">]</span></span>
<span class="line">            <span class="token key atrule">metering</span><span class="token punctuation">:</span></span>
<span class="line">                <span class="token key atrule">enabled</span><span class="token punctuation">:</span>              <span class="token boolean important">false</span></span>
<span class="line"></span>
<span class="line">                <span class="token comment"># The meter to use, defaults to \`metrics.default_meter\` or first meter in \`metrics.meters\`</span></span>
...
<span class="line">                    <span class="token key atrule">type</span><span class="token punctuation">:</span>                 always_on <span class="token comment"># One of &quot;always_off&quot;; &quot;always_on&quot;; &quot;parent_based_always_off&quot;; &quot;parent_based_always_on&quot;; &quot;parent_based_trace_id_ratio&quot;; &quot;trace_id_ratio&quot;; &quot;attribute_based&quot;; &quot;service&quot;, Required</span></span>
<span class="line"></span>
<span class="line">                    <span class="token comment"># Required if sampler type is service</span></span>
<span class="line">                    <span class="token key atrule">service_id</span><span class="token punctuation">:</span>           <span class="token null important">~</span></span>
...
<span class="line">                    <span class="token key atrule">type</span><span class="token punctuation">:</span>                 none <span class="token comment"># One of &quot;all&quot;; &quot;none&quot;; &quot;with_sampled_trace&quot;; &quot;service&quot;</span></span>
<span class="line"></span>
<span class="line">                    <span class="token comment"># Required if exemplar filter type is service</span></span>
<span class="line">                    <span class="token key atrule">service_id</span><span class="token punctuation">:</span>           <span class="token null important">~</span></span>
<span class="line">        <span class="token key atrule">exporters</span><span class="token punctuation">:</span></span>
<span class="line"></span>
<span class="line">            <span class="token comment"># Prototype</span></span>
...
<span class="line">            <span class="token comment"># Prototype</span></span>
<span class="line">            <span class="token key atrule">processor</span><span class="token punctuation">:</span></span>
<span class="line">                <span class="token key atrule">type</span><span class="token punctuation">:</span>                 simple <span class="token comment"># One of &quot;batch&quot;; &quot;multi&quot;; &quot;noop&quot;; &quot;simple&quot;, Required</span></span>
<span class="line"></span>
<span class="line">                <span class="token comment"># Required if processor type is multi</span></span>
<span class="line">                <span class="token key atrule">processors</span><span class="token punctuation">:</span>           <span class="token punctuation">[</span><span class="token punctuation">]</span></span>
<span class="line"></span>
<span class="line">                <span class="token comment"># Required if processor type is batch</span></span>
<span class="line">                <span class="token key atrule">batch</span><span class="token punctuation">:</span></span>
<span class="line">                    <span class="token key atrule">clock</span><span class="token punctuation">:</span>                open_telemetry.clock</span>
<span class="line">                    <span class="token key atrule">max_queue_size</span><span class="token punctuation">:</span>       <span class="token number">2048</span></span>
<span class="line">                    <span class="token key atrule">schedule_delay</span><span class="token punctuation">:</span>       <span class="token number">1000</span></span>
<span class="line">                    <span class="token key atrule">export_timeout</span><span class="token punctuation">:</span>       <span class="token number">30000</span></span>
<span class="line">                    <span class="token key atrule">max_export_batch_size</span><span class="token punctuation">:</span> <span class="token number">512</span></span>
<span class="line">                    <span class="token key atrule">auto_flush</span><span class="token punctuation">:</span>           <span class="token boolean important">true</span></span>
<span class="line">                    <span class="token key atrule">meter_provider</span><span class="token punctuation">:</span>       <span class="token null important">~</span></span>
<span class="line"></span>
<span class="line">                <span class="token comment"># Required if processor type is simple or batch</span></span>
<span class="line">                <span class="token key atrule">exporter</span><span class="token punctuation">:</span>             <span class="token null important">~</span></span>
<span class="line">        <span class="token key atrule">exporters</span><span class="token punctuation">:</span></span>
