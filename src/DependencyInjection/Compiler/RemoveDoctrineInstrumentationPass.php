...
class RemoveDoctrineInstrumentationPass implements CompilerPassInterface
{
    ...
    {
        if (false === $container->getParameter('open_telemetry.instrumentation.doctrine.tracing.enabled')) {
        ...
        if (false === $container->getParameter('open_telemetry.instrumentation.doctrine.metering.enabled')) {
        }
    }
}
