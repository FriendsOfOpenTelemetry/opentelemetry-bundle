...
class TwigTracingTest extends WebTestCase
{
    ...
    public function testFragment(): void
    {
        ...
        self::assertSpanAttributes($nativeFragmentSpan, [
            'url.full' => 'http://localhost/_fragment?_path=_format%3Dhtml%26_locale%3Den%26_controller%3DFriendsOfOpenTelemetry%255COpenTelemetryBundle%255CTests%255CFunctional%255CApplication%255CController%255CActionTraceableController%253A%253Aview',
        ...
        self::assertSpanName($mainSpan, 'friendsofopentelemetry_opentelemetry_tests_functional_application_actiontraceable_segment');
        ...
        self::assertSpanAttributes($mainSpan, [
            ...
            'server.address' => 'localhost',
            'server.port' => 80,
            'http.route' => 'friendsofopentelemetry_opentelemetry_tests_functional_application_actiontraceable_segment',
